  ...
  app.post('/api/v1/venta', function(req, res) {
    ...
    databaseConfig.getDb(destino).query(myquery, {
      ...
      for (i = 0; i < articulos.length; i++) {
        ...
        var myquery2 = 'INSERT INTO public.venta_articulo(${columns2^}) VALUES (' + id + ',' + articulos[i] + ') returning id';
      ...
      if (destino === 1) {
        ...
        if (error.code.localeCompare("ETIMEDOUT") === 0) {
          ...
          databaseConfig.getDb(1).query(myquery, {
              ...
              for (i = 0; i < articulos.length; i++) {
                const columns2 = ['id_venta', 'id_articulo'];
                var myquery2 = 'INSERT INTO public.venta_articulo(${columns2^}) VALUES (' + id + ',' + articulos[i] + ')';
